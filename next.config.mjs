    ...
    return [
      {
        ...
        headers: [
          ...
          // Next.js çalışma zamanı inline script/style kullandığı için o ikisi gerekli.
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' 'wasm-unsafe-eval' https://embed.tawk.to https://*.tawk.to",
              "style-src 'self' 'unsafe-inline' https://*.tawk.to",
              "img-src 'self' data: blob: https://*.tawk.to",
              "font-src 'self' data: https://*.tawk.to",
              "connect-src 'self' https://lichess.org https://*.tawk.to wss: ws:",
              "form-action 'self'",
              "frame-src https://*.tawk.to", "frame-ancestors 'none'",
              "base-uri 'self'",
              "object-src 'none'",
            ].join("; "),
          },
