...
// Turnuva programı — tüm saatler GMT (Türkiye saatinden 3 saat geride).
const SCHEDULE = `Tournament schedule (all times in GMT):
  <br>Round 1 — Wednesday, 12:00 GMT
  <br>Round 2 — Wednesday, 13:00 GMT
  <br>Quarter-final — Thursday, 12:00 GMT
  <br>Semi-final — Thursday, 13:00 GMT
  <br>Final — Friday, 13:00 GMT`;
  ...
  return {
    ...
    html: wrap({
      ...
      body: `Your application for the Fiba Games 2026 chess tournament has reached us.
        <br><br>Results will be announced on September 7, 2026.
  ...
  return {
    ...
    html: wrap({
      ...
      body: `Your opponent in the ${roundLabel}: ${opponent}.
        <br>Match time: ${timeText} (all tournament times are given in GMT).
