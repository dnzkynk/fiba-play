  ...
  return (
    <div className="flex min-h-[calc(100vh-16rem)] items-center justify-center py-6">
      <div className="grid w-full max-w-4xl overflow-hidden rounded-2xl border border-stone-200 bg-white shadow-xl lg:grid-cols-2">
        ...
        {/* Marka paneli */}
        <div
          className="relative hidden flex-col justify-between bg-fiba-950 p-10 text-white lg:flex"
          style={{
            backgroundImage:
          ...
          <div>
            ...
            <ul className="mt-8 flex flex-col gap-3.5">
              {bullets.map((b) => (
                <li key={b} className="flex items-start gap-3 text-sm text-fiba-200">
          ...
          <p className="text-xs text-fiba-400">FIBA Holding © 2026</p>
        </div>

        {/* Form paneli */}
        <div className="flex flex-col justify-center p-8 sm:p-12">
          <div className="mb-8 lg:hidden">
            <span className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl bg-linear-to-br from-fiba-600 to-fibagreen-500 text-lg text-white">♟</span>
          </div>
